<script lang="ts">
    ...
    const headers: SvelteCustom.DatatableHeaders<keyof Vehicle.Vehicle> = [ [ 'registrationNumber', 'Numer rejestracyjny' ], [ 'name', 'Nazwa' ], [ 'status', 'Status' ], [ 'assignedDriver', 'Kierowca' ], [ 'fuelCardId', 'Karta paliwowa' ],[ 'firstRegistrationDate', 'Data pierwszej rejestracji' ], [ 'notes', 'Notatki' ] ]
