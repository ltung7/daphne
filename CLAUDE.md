...
- Whenever types are not explicitly imported, they are in /src/app.d.ts file. At the same time, do not update the main types file withouth explicit instruction to do so.
